...
2.) Bundler 1.0 (gem install bundler --pre)
...
<!-- The library tries not to require 'rubygems' per http://gist.github.com/54177 and thus works fine on 1.9.2 but breaks on 1.8.7 unless you invoke any of the scripts with ruby -rubygems [whatever...] or set your RUBYOPT environment variable as noted above.  
